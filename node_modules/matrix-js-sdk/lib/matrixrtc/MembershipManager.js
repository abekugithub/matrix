...
export class MembershipManager extends TypedEventEmitter {
  ...
  makeMyMembership(expires) {
    var _this$fociPreferred, _this$ownMembership;
    var hasPreviousEvent = !!this.ownMembership;
    return _objectSpread({
      ...
      created_ts: (_this$ownMembership = this.ownMembership) === null || _this$ownMembership === void 0 ? void 0 : _this$ownMembership.createdTs()
    } : undefined);
  }
